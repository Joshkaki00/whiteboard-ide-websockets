...
import { getAllProblems, fetchAllLeetCodeProblems, searchProblems, getRandomProblem } from '../services/leetcodeService'
                ...
                <div className="p-3 border-b border-gray-200">
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      disabled={isLoading}
                      className="px-3 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg text-sm font-medium transition-colors flex items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed"
