...
export default function FeedbackWidget({ roomId }: FeedbackWidgetProps) {
  ...
  if (!isOpen) {
    return (
      <button
        onClick={handleOpen}
        className="fixed bottom-6 right-6 bg-purple-600 hover:bg-purple-700 text-white rounded-full p-4 shadow-lg transition-all hover:scale-105 z-50"
        title="Send Feedback"
      >
  ...
  if (submitted) {
    return (
      <div className="fixed bottom-6 right-6 bg-white rounded-2xl p-6 shadow-2xl z-50 w-80">
  ...
  return (
    <div className="fixed bottom-6 right-6 bg-white rounded-2xl p-6 shadow-2xl z-50 w-96 max-h-[600px] overflow-y-auto">
